...
## Prompt 49
> Vamos a implementar una pruebas unitarias cuentame que seria lo primero que se probaria

## Prompt 50
> Vamos a hacer una prueba unitaria al servicio de usuario, explicame paso por paso cual vas a hacer y porque

## Prompt 51
> Vamos a hacer por ahora solo el de load User

## Prompt 52
> Quiero que me saques un archivo de log de toda este chat en que se vea mis prompts y tus respuestas, que sea simple y de lectura facil

## Prompt 53
> Cuando se edita los detalles de un usuario tenemos que lanzar el spinner hasta que el back devuelva una respuesta y se actualice los datos visualmente
