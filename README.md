...
│   ├── models/user.model.ts                 # Modelos API (UserApi, UserDetailApi) y frontend (User, UserDetail)
...
ng serve          # 🖥️  Servidor de desarrollo en http://localhost:4200
...
| `PUT` | `/api/v1/users/:id` | ✏️ Actualizar un usuario |
